---
title: HTTPS加密过程和TLS证书验证
comments: true
categories: 网络编程
date: 2017-12-29 13:57:39
tags:
    - HTTPS/TLS
---
...
### 前言
大家都知道，苹果在[2016年WWDC](https://developer.apple.com/wwdc/)上宣布了关于应用需要强制使用`HTTPS`的规定。这也算是个好消息吧，虽然开发者们可能需要适配下`HTTPS`，但是我们的应用可算是披上一个安全的保护罩了。本篇文章就算是笔者在学习`HTTPS`过程中的一个记录吧。
...
![](http://ooqxuxrxe.bkt.clouddn.com/HTTPS%E5%8A%A0%E5%AF%86%E8%BF%87%E7%A8%8B.001.jpeg)

1. 客户端发起`HTTPS`请求
这个没什么好说的，就是用户在浏览器里输入一个`HTTPS`网址，然后连接到服务端的443端口。
2. 服务端的配置
...
![TLS握手](https://upload-images.jianshu.io/upload_images/2402164-be11eb2f83b02605.png)
...
![证书链](https://upload-images.jianshu.io/upload_images/2402164-db6c5a0d348fcc15.png)
...
![证书例子](http://ooqxuxrxe.bkt.clouddn.com/BACA45B95F7B1FEB75CE889445B8D3C6.jpg)
...
* [TLS如何保证安全](https://www.jianshu.com/p/24af67c40e8d)
* [图解HTTPS协议加密解密全过程](http://blog.csdn.net/aqiangsz/article/details/53611665)
